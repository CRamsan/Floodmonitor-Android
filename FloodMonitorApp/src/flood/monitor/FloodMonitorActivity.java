...
public class FloodMonitorActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ViewMap.setOnClickListener(new View.OnClickListener() {  
            public void onClick(View v) {  
            			Intent intent = new Intent(FloodMonitorActivity.this, MapViewActivity.class);
        ...
        PostPicture.setOnClickListener(new View.OnClickListener() {  
        	public void onClick(View v) {  
            			Intent intent = new Intent(FloodMonitorActivity.this, UploadFormActivity.class);
            			startActivity(intent);
                    }  
        });  
    }
        	...
        	builder.setMessage("This app requires internet connection.")
        	       ...
        	       .setNeutralButton("Exit", new DialogInterface.OnClickListener() {
        	           public void onClick(DialogInterface dialog, int id) {
        	                FloodMonitorActivity.this.finish();
        	           }
        	       });
